package ChameleonHash.PBCH.DEPRECATED.RPCH_TMM_2022;
...
public class MCL_G1_swap {
    ...
    public void Hash(HashValue H, Randomness R, PublicParam SP, MasterPublicKey mpk, PublicKey pk, base.LSSS.MCL.Matrix MSP, Fr m, int t) {
        ...
        Mcl.mul(H.b, pk.pk, m);
        Mcl.mul(G1_tmp[0], H.h, R.r);
        Mcl.add(H.b, H.b, G1_tmp[0]);
    ...
    public boolean Check(HashValue H, Randomness R, PublicKey pk, Fr m) {
        Mcl.mul(G1_tmp[0], pk.pk, m);
        Mcl.mul(G1_tmp[1], H.h, R.r);
        Mcl.add(G1_tmp[0], G1_tmp[0], G1_tmp[1]);
        return H.b.equals(G1_tmp[0]);
    }
