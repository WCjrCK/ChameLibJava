package ChameleonHash.CH.CH_AMV_2017;
...
public class MCL_G1 {
    public static class PublicParam {
        ...
        public AE.PKE_CPA_AMV_2017.MCL_G1.PublicParam PKE_CPA_PP = new AE.PKE_CPA_AMV_2017.MCL_G1.PublicParam();
        public AE.PKE_CCA_AMV_2017.MCL_G1.PublicParam PKE_CCA_PP = new AE.PKE_CCA_AMV_2017.MCL_G1.PublicParam();
        public HashMap<String, G1> Omega = new HashMap<>();
        public HashMap<String, Fr> Omega_inv = new HashMap<>();
    }

    public static class PublicKey {
        public AE.PKE_CPA_AMV_2017.MCL_G1.PublicKey PKE_CPA_PK = new AE.PKE_CPA_AMV_2017.MCL_G1.PublicKey();
        public AE.PKE_CCA_AMV_2017.MCL_G1.PublicKey PKE_CCA_PK = new AE.PKE_CCA_AMV_2017.MCL_G1.PublicKey();
        public G1 y = new G1();
    }

    public static class SecretKey {
        public AE.PKE_CPA_AMV_2017.MCL_G1.SecretKey PKE_CPA_SK = new AE.PKE_CPA_AMV_2017.MCL_G1.SecretKey();
        public AE.PKE_CCA_AMV_2017.MCL_G1.SecretKey PKE_CCA_SK = new AE.PKE_CCA_AMV_2017.MCL_G1.SecretKey();
        public Fr x = new Fr();
    }
    ...
    public static class EncRandomness {
        public base.NIZK.MCL_G1.DL_Proof pi_1, pi_2;
        public base.NIZK.MCL_G1.EQUAL_DL_Proof pi_3;
        public base.NIZK.MCL_G1.REPRESENT_Proof pi_4, pi_5;
        AE.PKE_CPA_AMV_2017.MCL_G1.CipherText PKE_CPA_CT = new AE.PKE_CPA_AMV_2017.MCL_G1.CipherText();
        AE.PKE_CCA_AMV_2017.MCL_G1.CipherText PKE_CCA_CT = new AE.PKE_CCA_AMV_2017.MCL_G1.CipherText();
    }

    AE.PKE_CPA_AMV_2017.MCL_G1 PKE_CPA = new AE.PKE_CPA_AMV_2017.MCL_G1();
    AE.PKE_CCA_AMV_2017.MCL_G1 PKE_CCA = new AE.PKE_CCA_AMV_2017.MCL_G1();
    ...
    private void genR(HashValue H, EncRandomness ER, Randomness R, PublicParam pp, PublicKey pk, Fr m) {
        ...
        ER.pi_1 = new base.NIZK.MCL_G1.DL_Proof(R.r, pp.g, G_tmp[0], Fr_tmp);

        pp.GP.GetZrElement(Fr_tmp[2]);
        AE.PKE_CPA_AMV_2017.MCL_G1.PlainText PKE_CPA_PT = new AE.PKE_CPA_AMV_2017.MCL_G1.PlainText();
        PKE_CPA_PT.m = R.r;
        PKE_CPA.Encrypt(ER.PKE_CPA_CT, pp.PKE_CPA_PP, pk.PKE_CPA_PK, PKE_CPA_PT, Fr_tmp[2]);
        ER.pi_2 = new base.NIZK.MCL_G1.DL_Proof(Fr_tmp[2], pp.PKE_CPA_PP.g, ER.PKE_CPA_CT.c_1, Fr_tmp);

        AE.PKE_CCA_AMV_2017.MCL_G1.PlainText PKE_CCA_PT = new AE.PKE_CCA_AMV_2017.MCL_G1.PlainText();
        PKE_CCA_PT.m = R.r;
        PKE_CCA.Encrypt(ER.PKE_CCA_CT, pp.PKE_CCA_PP, pk.PKE_CCA_PK, PKE_CCA_PT, Fr_tmp[3]);
        ER.pi_3 = new base.NIZK.MCL_G1.EQUAL_DL_Proof(Fr_tmp[3], pp.PKE_CCA_PP.g_1, ER.PKE_CCA_CT.c_1, pp.PKE_CCA_PP.g_2, ER.PKE_CCA_CT.c_2, Fr_tmp);
        pp.PKE_CCA_PP.H(Fr_tmp[4], ER.PKE_CCA_CT.c_1, ER.PKE_CCA_CT.c_2, ER.PKE_CCA_CT.c_3);
        Mcl.mul(Fr_tmp[4], Fr_tmp[3], Fr_tmp[4]);
        ER.pi_4 = new base.NIZK.MCL_G1.REPRESENT_Proof(ER.PKE_CCA_CT.c_4, pk.PKE_CCA_PK.y_1, Fr_tmp[3], pk.PKE_CCA_PK.y_2, Fr_tmp[4], G_tmp, Fr_tmp);
        Mcl.sub(G_tmp[1], ER.PKE_CPA_CT.c_2, ER.PKE_CCA_CT.c_3);
        Mcl.neg(G_tmp[2], pk.PKE_CCA_PK.y_3);
        ER.pi_5 = new base.NIZK.MCL_G1.REPRESENT_Proof(G_tmp[1], pk.PKE_CPA_PK.y, Fr_tmp[2], G_tmp[2], Fr_tmp[3], G_tmp, Fr_tmp);
    }
    ...
    public void Adapt(EncRandomness ER_p, Randomness R_p, HashValue H, EncRandomness ER, PublicParam pp, PublicKey pk, SecretKey sk, Fr m, Fr m_p) {
        ...
        AE.PKE_CPA_AMV_2017.MCL_G1.PlainText CPA_PT = new AE.PKE_CPA_AMV_2017.MCL_G1.PlainText();
