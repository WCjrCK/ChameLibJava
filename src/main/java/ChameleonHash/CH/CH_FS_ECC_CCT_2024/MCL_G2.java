package ChameleonHash.CH.CH_FS_ECC_CCT_2024;
...
public class MCL_G2 {
    public static class PublicParam {
        ...
        public void H(G2 res, Fr m) {
            Hash.H_MCL_G2_1(res, m.toString());
        }

        public void H_p(Fr res, G2 m1, G2 m2, G2 m3, Fr m4) {
            H_p(res, String.format("%s|%s|%s|%s", m1, m2, m3, m4));
        }
    }

    public static class PublicKey {
        public G2 g_x = new G2();
    }
