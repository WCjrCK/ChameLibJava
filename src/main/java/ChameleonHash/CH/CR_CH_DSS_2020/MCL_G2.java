package ChameleonHash.CH.CR_CH_DSS_2020;
...
public class MCL_G2 {
    public static class PublicParam {
        public base.GroupParam.MCL.SingleGroup.SingleGroupG2 GP = new base.GroupParam.MCL.SingleGroup.SingleGroupG2();
        public G2 g = new G2();
        ...
        public void H(Fr res, G2 m1, G2 m2, G2 m3, G2 m4, G2 m5, G2 m6, G2 m7) {
    ...
    public void Hash(HashValue H, Randomness R, PublicParam pp, PublicKey pk, G2 m) {
    ...
    public boolean Check(HashValue H, Randomness R, PublicParam pp, PublicKey pk, G2 m) {
    ...
    public void Adapt(Randomness R_p, HashValue H, Randomness R, PublicParam pp, PublicKey pk, SecretKey sk, G2 m, G2 m_p) {
