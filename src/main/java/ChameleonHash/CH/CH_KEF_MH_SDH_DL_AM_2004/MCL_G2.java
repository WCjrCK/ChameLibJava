package ChameleonHash.CH.CH_KEF_MH_SDH_DL_AM_2004;
...
public class MCL_G2 {
    ...
    public static class Randomness {
        public G2 g_r = new G2();
        public base.NIZK.MCL_G2.DH_PAIR_Proof pi;
    }

    private final G2[] G_tmp = new G2[]{new G2(), new G2(), new G2(), new G2(), new G2()};
    ...
    public void Hash(HashValue h, Randomness r, PublicParam PP, PublicKey pk, Fr L, Fr m) {
        ...
        r.pi = new base.NIZK.MCL_G2.DH_PAIR_Proof(Fr_tmp[1], pk.g, r.g_r, G_tmp[3], G_tmp[4], G_tmp, Fr_tmp);
    }
    ...
    public void Adapt(Randomness r_p, HashValue h, Randomness r, PublicParam PP, PublicKey pk, SecretKey sk, Fr L, Fr m, Fr m_p) {
        ...
        r_p.pi = new base.NIZK.MCL_G2.DH_PAIR_Proof(Fr_tmp[1], pk.g, G_tmp[3], r_p.g_r, G_tmp[4], G_tmp, Fr_tmp);
    }
}
