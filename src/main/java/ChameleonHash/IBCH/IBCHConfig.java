...
public class IBCHConfig {
    public IBCHName schemeName;
    public EllipticCurve.Curve.Config curveConfig;
    public Map<String, Object> params;

    public IBCHConfig(IBCHName schemeName, EllipticCurve.Curve.Config curveConfig, Map<String, Object> params) {
    ...
    public IBCHConfig(IBCHName schemeName, EllipticCurve.Curve.Config curveConfig) {
