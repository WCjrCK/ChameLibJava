...
public class MCL_G1 {
    ...
    public static class DL_Proof extends Proof {
        public G1 alpha = new G1();
        public Fr gamma = new Fr();

        public DL_Proof(Fr x, G1 g, G1 y) {
            this(x, g, y, new Fr[]{new Fr()});
        }

        public DL_Proof(Fr x, G1 g, G1 y, Fr[] Fr_tmp) {
            Mcl.mul(alpha, g, x);
        ...
        public boolean Check(G1 g, G1 y) {
            return Check(g, y, new G1[]{new G1(), new G1()}, new Fr[]{new Fr()});
        }

        public boolean Check(G1 g, G1 y, G1[] G_tmp, Fr[] Fr_tmp) {
    ...
    public static class EQUAL_DL_Proof extends Proof {
        public G1 alpha_1 = new G1(), alpha_2 = new G1();
        public Fr gamma = new Fr();

        public EQUAL_DL_Proof(Fr x, G1 g_1, G1 y_1, G1 g_2, G1 y_2) {
            this(x, g_1, y_1, g_2, y_2, new Fr[]{new Fr()});
        }

        public EQUAL_DL_Proof(Fr x, G1 g_1, G1 y_1, G1 g_2, G1 y_2, Fr[] Fr_tmp) {
        ...
        public boolean Check(G1 g_1, G1 y_1, G1 g_2, G1 y_2) {
            return Check(g_1, y_1, g_2, y_2, new G1[]{new G1(), new G1()}, new Fr[]{new Fr()});
        }

        public boolean Check(G1 g_1, G1 y_1, G1 g_2, G1 y_2, G1[] G_tmp, Fr[] Fr_tmp) {
    ...
    public static class REPRESENT_Proof extends Proof {
        ...
        public REPRESENT_Proof(G1 y, G1 g_1, Fr x_1, G1 g_2, Fr x_2) {
            this(y, g_1, x_1, g_2, x_2, new G1[]{new G1()}, new Fr[]{new Fr(), new Fr()});
        }

        public REPRESENT_Proof(G1 y, G1 g_1, Fr x_1, G1 g_2, Fr x_2, G1[] G_tmp, Fr[] Fr_tmp) {
        ...
        public boolean Check(G1 y, G1 g_1, G1 g_2) {
            return Check(y, g_1, g_2, new G1[]{new G1(), new G1()}, new Fr[]{new Fr()});
        }

        public boolean Check(G1 y, G1 g_1, G1 g_2, G1[] G_tmp, Fr[] Fr_tmp) {
