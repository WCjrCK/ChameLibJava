...
public class MCL_swap {
    public static class PublicParam {
        public G2 P = new G2(), P_pub = new G2();
    ...
    private static void getHashValue(G2 h, Randomness R, PublicParam SP, String L, Fr m) {
        SP.H_G2(h, L);
        Mcl.mul(h, h, m);
        Mcl.add(h, R.r_1, h);
    }
    ...
    public void Hash(HashValue H, Randomness R, PublicParam SP, String ID, String L, Fr m) {
        ...
        SP.H_G1(G1_tmp[0], ID);
        Mcl.pairing(R.r_2, G1_tmp[0], R.r_1);
    ...
    public boolean Check(HashValue H, Randomness R, PublicParam SP, SecretKey sk, String L, Fr m) {
        Mcl.pairing(GT_tmp[0], sk.S_ID, R.r_1);
        getHashValue(G2_tmp[0], R, SP, L, m);
        return R.r_2.equals(GT_tmp[0]) && H.h.equals(G2_tmp[0]);
    }

    public void Adapt(Randomness R_p, Randomness R, PublicParam SP, SecretKey sk, String L, Fr m, Fr m_p) {
        Mcl.sub(Fr_tmp[0], m, m_p);
        SP.H_G2(R_p.r_1, L);
        Mcl.pairing(R_p.r_2, sk.S_ID, R_p.r_1);
        ...
        Mcl.pairing(GT_tmp[0], sk.S_ID, R_p.r_1);
