...
public class Config {
    ...
    public Config(SchemeName schemeName, EllipticCurve.Curve.Config curveConfig, Map<String, Object> params) {
    ...
    public Config(SchemeName schemeName, EllipticCurve.Curve.Config curveConfig) {
