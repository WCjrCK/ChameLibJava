...
public class PBC {
    ...
    public void Hash(HashValue H, Randomness R, PublicParam pp, PublicKey pk, Element m) {
        ...
        R.e_1 = pp.H(String.format("(%s|%s|%s)(%s|%s)", pk.y, H.O, m, pp.g_1.powZn(k_1_1).mul(pp.g_2.powZn(k_1_2)), pp.g_1.powZn(R.s_2).mul(pk.y.powZn(R.e_2.negate())))).sub(R.e_2);
    ...
    public boolean Check(HashValue H, Randomness R, PublicParam pp, PublicKey pk, Element m) {
        return R.e_1.add(R.e_2).isEqual(pp.H(String.format("(%s|%s|%s)(%s|%s)", pk.y, H.O, m,
                pp.g_1.powZn(R.s_1_1).mul(pp.g_2.powZn(R.s_1_2)).mul(H.O.powZn(R.e_1.negate())), pp.g_1.powZn(R.s_2).mul(pk.y.powZn(R.e_2.negate()))))
        );
    }
    ...
    public void Adapt(Randomness R_p, HashValue H, Randomness R,PublicParam pp, PublicKey pk, SecretKey sk, Element m, Element m_p) {
        ...
        R_p.e_2 = pp.H(String.format("(%s|%s|%s)(%s|%s)", pk.y, H.O, m_p,
                pp.g_1.powZn(R_p.s_1_1).mul(pp.g_2.powZn(R_p.s_1_2)).mul(H.O.powZn(R_p.e_1.negate())), pp.g_1.powZn(k_2))).sub(R_p.e_1).getImmutable();
