...
public class MCL_G2 {
    ...
    public void KeyGen(PublicKey pk, SecretKey sk, PublicParam pp) {
        ...
        pk.pi_pk = new base.NIZK.MCL_G2.DL_Proof(sk.x, pp.g, pk.h);
    ...
    public void Hash(HashValue H, Randomness R, ETrapdoor etd, PublicParam pp, PublicKey pk, Fr m) {
        ...
        H.pi_t = new base.NIZK.MCL_G2.DL_Proof(etd.etd, pp.g, H.h_p);
        R.C = AE.RSA.Native.Encrypt(new BigInteger(Fr_tmp[0].toString()), pk.pk_enc);
        Mcl.mul(R.p, pk.h, Fr_tmp[0]);
        R.pi_p = new base.NIZK.MCL_G2.DL_Proof(Fr_tmp[0], pk.h, R.p);
        pp.H(Fr_tmp[0], m);
        Mcl.mul(H.b, H.h_p, Fr_tmp[0]);
        Mcl.add(H.b, H.b, R.p);
    }
    ...
    public void Adapt(Randomness R_p, HashValue H, Randomness R, ETrapdoor etd, PublicParam pp, PublicKey pk, SecretKey sk, Fr m, Fr m_p) {
        ...
        pp.H(Fr_tmp[1], m);
        Fr_tmp[2] = new Fr();
        Mcl.mul(Fr_tmp[2], Fr_tmp[0], sk.x);
        Mcl.mul(G_tmp[0], pp.g, Fr_tmp[2]);
