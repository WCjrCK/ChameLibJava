...
public class PBC {
    ...
    public static class PublicKey {
        public Element h;
        public base.NIZK.PBC.DL_Proof pi_pk1;
    ...
    public static class HashValue {
        ...
        public base.NIZK.PBC.DL_Proof pi_t1;
    }

    public static class Randomness {
        public Element p;
        public BigInteger C;
        public base.NIZK.PBC.DL_Proof pi_p1;
    }
    ...
    public void KeyGen(PublicKey pk, SecretKey sk, PublicParam pp) {
        ...
        pk.pi_pk1 = new base.NIZK.PBC.DL_Proof(pp.GP.Zr, sk.x, pp.g, pk.h);
    ...
    public void Hash(HashValue H, Randomness R, ETrapdoor etd, PublicParam pp, PublicKey pk, Element m) {
        if(!pk.pi_pk1.Check(pp.g, pk.h)) throw new RuntimeException("not valid proof");
        Element r = pp.GP.GetZrElement();
        etd.etd = pp.GP.GetZrElement();
        H.h_p = pp.g.powZn(etd.etd).getImmutable();
        H.pi_t1 = new base.NIZK.PBC.DL_Proof(pp.GP.Zr, etd.etd, pp.g, H.h_p);
        R.C = AE.RSA.Native.Encrypt(r.toBigInteger(), pk.pk_enc);
        Element a = pp.H(m);
        R.p = pk.h.powZn(r).getImmutable();
        R.pi_p1 = new base.NIZK.PBC.DL_Proof(pp.GP.Zr, r, pk.h, R.p);
    ...
    public boolean Check(HashValue H, Randomness R, PublicParam pp, PublicKey pk, Element m) {
        if(!R.pi_p1.Check(pk.h, R.p) || !H.pi_t1.Check(pp.g, H.h_p) || !pk.pi_pk1.Check(pp.g, pk.h))
    ...
    public void Adapt(Randomness R_p, HashValue H, Randomness R, ETrapdoor etd, PublicParam pp, PublicKey pk, SecretKey sk, Element m, Element m_p) {
        ...
        R_p.pi_p1 = new base.NIZK.PBC.DL_Proof(pp.GP.Zr, r_p, pk.h, R_p.p);
    }
}
