...
//        }
    ...
    private void genR(HashValue H, Randomness R, PublicParam pp, PublicKey pk, Element m) {
        R.pi_1 = new base.NIZK.PBC.DL_Proof(pp.Zr, R.r, pp.g, H.h.mul(pk.y.powZn(m)));

        Element rho_1 = pp.GetZrElement();
        AE.PKE_CPA_AMV_2017.PBC.PlainText PKE_CPA_PT = new AE.PKE_CPA_AMV_2017.PBC.PlainText();
        PKE_CPA_PT.m = R.r;
        PKE_CPA.Encrypt(R.PKE_CPA_CT, pp.PKE_CPA_PP, pk.PKE_CPA_PK, PKE_CPA_PT, rho_1);
        R.pi_2 = new base.NIZK.PBC.DL_Proof(pp.Zr, rho_1, pp.PKE_CPA_PP.g, R.PKE_CPA_CT.c_1);

        Element rho_2 = pp.GetZrElement();
        AE.PKE_CCA_AMV_2017.PBC.PlainText PKE_CCA_PT = new AE.PKE_CCA_AMV_2017.PBC.PlainText();
        PKE_CCA_PT.m = R.r;
        PKE_CCA.Encrypt(R.PKE_CCA_CT, pp.PKE_CCA_PP, pk.PKE_CCA_PK, PKE_CCA_PT, rho_2);
        R.pi_3 = new base.NIZK.PBC.EQUAL_DL_Proof(pp.Zr, rho_2, pp.PKE_CCA_PP.g_1, R.PKE_CCA_CT.c_1, pp.PKE_CCA_PP.g_2, R.PKE_CCA_CT.c_2);

        R.pi_4 = new base.NIZK.PBC.REPRESENT_Proof(pp.Zr, R.PKE_CCA_CT.c_4, pk.PKE_CCA_PK.y_1, rho_2, pk.PKE_CCA_PK.y_2, rho_2.mul(pp.PKE_CCA_PP.H(R.PKE_CCA_CT.c_1, R.PKE_CCA_CT.c_2, R.PKE_CCA_CT.c_3)));
        R.pi_5 = new base.NIZK.PBC.REPRESENT_Proof(pp.Zr, R.PKE_CPA_CT.c_2.div(R.PKE_CCA_CT.c_3), pk.PKE_CPA_PK.y, rho_1, pk.PKE_CCA_PK.y_3.invert(), rho_2);
    }
    ...
    public boolean Check(HashValue H, Randomness R, PublicParam pp, PublicKey pk, Element m) {
        return R.pi_1.Check(pp.g, H.h.mul(pk.y.powZn(m))) &&
                R.pi_2.Check(pp.PKE_CPA_PP.g, R.PKE_CPA_CT.c_1) &&
                R.pi_3.Check(pp.PKE_CCA_PP.g_1, R.PKE_CCA_CT.c_1, pp.PKE_CCA_PP.g_2, R.PKE_CCA_CT.c_2) &&
                R.pi_4.Check(R.PKE_CCA_CT.c_4, pk.PKE_CCA_PK.y_1, pk.PKE_CCA_PK.y_2) &&
                R.pi_5.Check(R.PKE_CPA_CT.c_2.div(R.PKE_CCA_CT.c_3), pk.PKE_CPA_PK.y, pk.PKE_CCA_PK.y_3.invert()) &&
                H.h.isEqual(pp.g.powZn(R.r).div(pk.y.powZn(m)).getImmutable());
    }
    ...
    public void Adapt(Randomness R_p, HashValue H, Randomness R, PublicParam pp, PublicKey pk, SecretKey sk, Element m, Element m_p) {
        ...
        R_p.r = R.r.sub(sk.x.mul(m.sub(m_p))).getImmutable();
        genR(H, R_p, pp, pk, m_p);
    }
}
