...
public class Core {
    public static void Setup(MasterPublicKey mpk, MasterSecretKey msk, PublicParam pp, Scalar d_1, Scalar d_2, Scalar d_3, Scalar alpha) {
    ...
    public static void KeyGen(SecretKey sk, PublicParam pp, MasterPublicKey mpk, MasterSecretKey msk, Attributes S, Scalar r_1, Scalar r_2, Scalar alpha) {
    ...
    public static void Encrypt(CipherText ct, PublicParam pp, MasterPublicKey mpk, Policy P, PlainText pt, Scalar s_1, Scalar s_2) {
