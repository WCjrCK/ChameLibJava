...
import ChameleonHash.CH.CH_FS_ECC_CCT_2024.MCL_G1;
import ChameleonHash.CH.CH_FS_ECC_CCT_2024.MCL_G2;
import ChameleonHash.CH.CH_FS_ECC_CCT_2024.MCL_GT;
import utils.Func;
...
public class CH_FS_ECC_CCT_2024 extends BasicParam {
    ...
    static void initTest() {
        InitialLib();
        try {
            File_Writer = new BufferedWriter(new FileWriter("./data/MCL/CH/CH_FS_ECC_CCT_2024.txt"));
