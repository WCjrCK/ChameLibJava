...
import ChameleonHash.CH.FCR_CH_PreQA_DKS_2020.MCL_G1;
import ChameleonHash.CH.FCR_CH_PreQA_DKS_2020.MCL_G2;
import ChameleonHash.CH.FCR_CH_PreQA_DKS_2020.MCL_GT;
import utils.Func;
...
public class FCR_CH_PreQA_DKS_2020 extends BasicParam {
    ...
    static void initTest() {
        InitialLib();
        try {
            File_Writer = new BufferedWriter(new FileWriter("./data/MCL/CH/FCR_CH_PreQA_DKS_2020.txt"));
