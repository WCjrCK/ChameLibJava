...
public class TheoTimeTest {
    ...
    class CHTSCTest {
        ...
        private void testBaseCH(BufferedWriter theo_time_cost, ChameleonHash.Config schemeConfig) throws IOException {
        ...
        private void testLabelCH(BufferedWriter theo_time_cost, ChameleonHash.Config schemeConfig) throws IOException {
